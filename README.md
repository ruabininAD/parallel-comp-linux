...
Можно создавать переменные окружения и использовать их в своих скриптах или программных приложениях для хранения настроек или передачи информации между различными компонентами системы.
...
Значения переменных окружения могут быть установлены, изменены или удалены с помощью командной строки, скриптов или конфигурационных файлов, в зависимости от ваших потребностей.
 ...
 - Для компиляции программы необходимо
   -  Установить Openmpi
    `sudo dnf update`
    `sudo dnf install openmpi-bin gcc`  
...
Проверка работоспособности openmpi на примере hello_c.c из официальной документации. 
